...
namespace Map
{
    public class Select : MapTools
    {
        static public readonly Select Instance = new Select();
        ...
        Select()
        {
            ...
            this.m_CommandType = CommandType.Select;
        ...
        {
            SelectedItems.Clear();
            Rectangle rect = new Rectangle(Brushes.White,new Pen(Brushes.Yellow, 0.0),DragLine.m_DragHollowRect.Rect);
            switch (TargetType)
            {
